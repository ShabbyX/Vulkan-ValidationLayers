...
def runTest(vuList, expected):
    ...
    # Make sure original ASTs are identical to given vus.  Remove id from variable names, then make
    # sure it gets dumped to the same AST.
...
if varC1_1 > 0:
 ...
 for value_3 in values:
  require(value_3 + var2_2 + var1_0 > varC1_1, 0, 0)
 var2_2 = b + varC1_1
else:
 var3_4 = var1_0.has_bit(foo)
 varC2_5 = a + varC1_1
 for value_6 in values:
  require(varC2_5 == var3_4, 0, 1)
 var2_7 = b + varC1_1
for value_8 in values:
 require(value_8 != -value_8, 0, 2)
require(varC1_1 == varC1_1, 0, 3)
"""
...
if a_0 == constant1 or constant3:
 require(a_0 != constant3, 1, 0)
elif a_0 == constant1:
 require(should_not_merge(), 1, 1)
if a_0 != constant1:
 a_3 = constant2
 require(a_3 + a_0 > 0, 1, 2)
"""
...
for r_1 in rs:
 ...
 require(r_1 != -1, 1, 0)
 if r_1 == 0:
  require(loop_index(r_1) == 0, 1, 1)
require(b_0 < constant1, 0, 0)

for t_2 in ts:
 if t_2.a != -1:
  require(t_2.a >= 0, 0, 1)
  require(t_2.b > t_2.a, 1, 2)
 require(constant2, 1, 3)"""
...
for r in array:
 ...
 require(r == constant3)"""]
    ...
    expect = """array_1 = rs
for r_0 in rs:
 require(r_0 < constant1, 0, 0)

for r_2 in array_1:
 require(r_2 > constant2, 1, 0)

for r_3 in rs2:
 require(r_3 == constant3, 2, 0)"""
...
for r_1 in rs:
 require(r_1 > constant2, 1, 0)

for r_2 in rs:
 if r_2 > 10:
  break
 require(r_2 == constant3, 2, 0)
...
require(True)""",
 ...
 while loop_index(r_0) == 0:
  ...
  if a_1 > 0:
   break
 require(a_1 < constant1, 0, 0)
 require(r_0 > constant2, 1, 0)
 for t_5 in ts:
  require(t_5, 3, 0)
  break
 if r_0 > 10:
