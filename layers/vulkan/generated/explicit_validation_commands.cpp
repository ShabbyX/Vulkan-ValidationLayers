...
bool ExplicitValidation::PreCallValidateCreateAccelerationStructureKHR(VkDevice device,
    ...
    bool skip = false;
    if (pCreateInfo != nullptr) {
        const auto _s436 = pCreateInfo;
        skip |= ValidateAccelerationStructureCreateInfoKHR({}, _s436->sType, _s436->pNext, _s436->createFlags, _s436->buffer,
                                                           _s436->offset, _s436->size, _s436->type, _s436->deviceAddress);
    }
    if (pAllocator != nullptr) {
        const auto _s437 = pAllocator;
        skip |= ValidateAllocationCallbacks({}, _s437->pUserData, _s437->pfnAllocation, _s437->pfnReallocation, _s437->pfnFree,
                                            _s437->pfnInternalAllocation, _s437->pfnInternalFree);
    }
    return skip;
}
bool ExplicitValidation::PreCallValidateDestroyAccelerationStructureKHR(VkDevice device,
    ...
    bool skip = false;
    if (pAllocator != nullptr) {
        const auto _s438 = pAllocator;
        skip |= ValidateAllocationCallbacks({}, _s438->pUserData, _s438->pfnAllocation, _s438->pfnReallocation, _s438->pfnFree,
                                            _s438->pfnInternalAllocation, _s438->pfnInternalFree);
    }
    return skip;
}
bool ExplicitValidation::PreCallValidateCmdBuildAccelerationStructuresKHR(
    ...
    _carryOverObjects.add(commandBuffer);
    if (pInfos != nullptr) {
        for (uint32_t _i439 = 0; _i439 < infoCount; ++_i439) {
            const auto _s440 = &pInfos[_i439];
            skip |= ValidateAccelerationStructureBuildGeometryInfoKHR(_carryOverObjects, _s440->sType, _s440->pNext, _s440->type,
                                                                      _s440->flags, _s440->mode, _s440->srcAccelerationStructure,
                                                                      _s440->dstAccelerationStructure, _s440->geometryCount,
                                                                      _s440->pGeometries, _s440->ppGeometries, _s440->scratchData);
        }
    }
    if (ppBuildRangeInfos != nullptr) {
        for (uint32_t _i441 = 0; _i441 < infoCount; ++_i441) {
            const auto _s442 = ppBuildRangeInfos[_i441];
            skip |= ValidateAccelerationStructureBuildRangeInfoKHR(_carryOverObjects, _s442->primitiveCount, _s442->primitiveOffset,
                                                                   _s442->firstVertex, _s442->transformOffset);
        }
    }
    return skip;
}
bool ExplicitValidation::PreCallValidateCmdBuildAccelerationStructuresIndirectKHR(
    ...
    _carryOverObjects.add(commandBuffer);
    if (pInfos != nullptr) {
        for (uint32_t _i443 = 0; _i443 < infoCount; ++_i443) {
            const auto _s444 = &pInfos[_i443];
            skip |= ValidateAccelerationStructureBuildGeometryInfoKHR(_carryOverObjects, _s444->sType, _s444->pNext, _s444->type,
                                                                      _s444->flags, _s444->mode, _s444->srcAccelerationStructure,
                                                                      _s444->dstAccelerationStructure, _s444->geometryCount,
                                                                      _s444->pGeometries, _s444->ppGeometries, _s444->scratchData);
        }
    }
    return skip;
}
bool ExplicitValidation::PreCallValidateBuildAccelerationStructuresKHR(
    ...
    bool skip = false;
    if (pInfos != nullptr) {
        for (uint32_t _i445 = 0; _i445 < infoCount; ++_i445) {
            const auto _s446 = &pInfos[_i445];
            skip |= ValidateAccelerationStructureBuildGeometryInfoKHR(
                {}, _s446->sType, _s446->pNext, _s446->type, _s446->flags, _s446->mode, _s446->srcAccelerationStructure,
                _s446->dstAccelerationStructure, _s446->geometryCount, _s446->pGeometries, _s446->ppGeometries, _s446->scratchData);
        }
    }
    if (ppBuildRangeInfos != nullptr) {
        for (uint32_t _i447 = 0; _i447 < infoCount; ++_i447) {
            const auto _s448 = ppBuildRangeInfos[_i447];
            skip |= ValidateAccelerationStructureBuildRangeInfoKHR({}, _s448->primitiveCount, _s448->primitiveOffset,
                                                                   _s448->firstVertex, _s448->transformOffset);
        }
    }
    return skip;
}
bool ExplicitValidation::PreCallValidateCopyAccelerationStructureKHR(VkDevice device, VkDeferredOperationKHR deferredOperation,
    ...
    bool skip = false;
    if (pInfo != nullptr) {
        const auto _s449 = pInfo;
        skip |= ValidateCopyAccelerationStructureInfoKHR({}, _s449->sType, _s449->pNext, _s449->src, _s449->dst, _s449->mode);
    }
    return skip;
}
bool ExplicitValidation::PreCallValidateCopyAccelerationStructureToMemoryKHR(
    ...
    bool skip = false;
    if (pInfo != nullptr) {
        const auto _s450 = pInfo;
        skip |=
            ValidateCopyAccelerationStructureToMemoryInfoKHR({}, _s450->sType, _s450->pNext, _s450->src, _s450->dst, _s450->mode);
    }
    return skip;
}
bool ExplicitValidation::PreCallValidateCopyMemoryToAccelerationStructureKHR(
    ...
    bool skip = false;
    if (pInfo != nullptr) {
        const auto _s451 = pInfo;
        skip |=
            ValidateCopyMemoryToAccelerationStructureInfoKHR({}, _s451->sType, _s451->pNext, _s451->src, _s451->dst, _s451->mode);
    }
    return skip;
}
...
bool ExplicitValidation::PreCallValidateCmdCopyAccelerationStructureKHR(VkCommandBuffer commandBuffer,
    ...
    _carryOverObjects.add(commandBuffer);
    if (pInfo != nullptr) {
        const auto _s452 = pInfo;
        skip |= ValidateCopyAccelerationStructureInfoKHR(_carryOverObjects, _s452->sType, _s452->pNext, _s452->src, _s452->dst,
                                                         _s452->mode);
    }
    return skip;
}
bool ExplicitValidation::PreCallValidateCmdCopyAccelerationStructureToMemoryKHR(
    ...
    _carryOverObjects.add(commandBuffer);
    if (pInfo != nullptr) {
        const auto _s453 = pInfo;
        skip |= ValidateCopyAccelerationStructureToMemoryInfoKHR(_carryOverObjects, _s453->sType, _s453->pNext, _s453->src,
                                                                 _s453->dst, _s453->mode);
    }
    return skip;
}
bool ExplicitValidation::PreCallValidateCmdCopyMemoryToAccelerationStructureKHR(
    ...
    if (pInfo != nullptr) {
        ...
        skip |= ValidateCopyMemoryToAccelerationStructureInfoKHR(_carryOverObjects, _s454->sType, _s454->pNext, _s454->src,
                                                                 _s454->dst, _s454->mode);
    }
    return skip;
}
bool ExplicitValidation::PreCallValidateGetAccelerationStructureDeviceAddressKHR(
    ...
    if (pInfo != nullptr) {
        ...
        skip |= ValidateAccelerationStructureDeviceAddressInfoKHR({}, _s455->sType, _s455->pNext, _s455->accelerationStructure);
    }
    return skip;
}
...
bool ExplicitValidation::PreCallValidateGetDeviceAccelerationStructureCompatibilityKHR(
    ...
    bool skip = false;
    if (pVersionInfo != nullptr) {
        const auto _s456 = pVersionInfo;
        skip |= ValidateAccelerationStructureVersionInfoKHR({}, _s456->sType, _s456->pNext, _s456->pVersionData);
    }
    return skip;
}
bool ExplicitValidation::PreCallValidateGetAccelerationStructureBuildSizesKHR(
    ...
    bool skip = false;
    if (pBuildInfo != nullptr) {
        const auto _s457 = pBuildInfo;
        skip |= ValidateAccelerationStructureBuildGeometryInfoKHR(
            {}, _s457->sType, _s457->pNext, _s457->type, _s457->flags, _s457->mode, _s457->srcAccelerationStructure,
            _s457->dstAccelerationStructure, _s457->geometryCount, _s457->pGeometries, _s457->ppGeometries, _s457->scratchData);
    }
    if (pSizeInfo != nullptr) {
        const auto _s458 = pSizeInfo;
        skip |= ValidateAccelerationStructureBuildSizesInfoKHR({}, _s458->sType, _s458->pNext, _s458->accelerationStructureSize,
                                                               _s458->updateScratchSize, _s458->buildScratchSize);
    }
    return skip;
}
bool ExplicitValidation::PreCallValidateCmdTraceRaysKHR(VkCommandBuffer commandBuffer,
    ...
    if (pRaygenShaderBindingTable != nullptr) {
        const auto _s459 = pRaygenShaderBindingTable;
        skip |= ValidateStridedDeviceAddressRegionKHR(_carryOverObjects, _s459->deviceAddress, _s459->stride, _s459->size);
    }
    if (pMissShaderBindingTable != nullptr) {
        const auto _s460 = pMissShaderBindingTable;
        skip |= ValidateStridedDeviceAddressRegionKHR(_carryOverObjects, _s460->deviceAddress, _s460->stride, _s460->size);
    }
    if (pHitShaderBindingTable != nullptr) {
        const auto _s461 = pHitShaderBindingTable;
        skip |= ValidateStridedDeviceAddressRegionKHR(_carryOverObjects, _s461->deviceAddress, _s461->stride, _s461->size);
    }
    if (pCallableShaderBindingTable != nullptr) {
        const auto _s462 = pCallableShaderBindingTable;
        skip |= ValidateStridedDeviceAddressRegionKHR(_carryOverObjects, _s462->deviceAddress, _s462->stride, _s462->size);
    }
    return skip;
}
bool ExplicitValidation::PreCallValidateCreateRayTracingPipelinesKHR(VkDevice device, VkDeferredOperationKHR deferredOperation,
    ...
    bool skip = false;
    if (pCreateInfos != nullptr) {
        for (uint32_t _i463 = 0; _i463 < createInfoCount; ++_i463) {
            const auto _s464 = &pCreateInfos[_i463];
            skip |= ValidateRayTracingPipelineCreateInfoKHR(
                {}, _s464->sType, _s464->pNext, _s464->flags, _s464->stageCount, _s464->pStages, _s464->groupCount, _s464->pGroups,
                _s464->maxPipelineRayRecursionDepth, _s464->pLibraryInfo, _s464->pLibraryInterface, _s464->pDynamicState,
                _s464->layout, _s464->basePipelineHandle, _s464->basePipelineIndex);
        }
    }
    if (pAllocator != nullptr) {
        const auto _s465 = pAllocator;
        skip |= ValidateAllocationCallbacks({}, _s465->pUserData, _s465->pfnAllocation, _s465->pfnReallocation, _s465->pfnFree,
                                            _s465->pfnInternalAllocation, _s465->pfnInternalFree);
    }
    return skip;
}
...
bool ExplicitValidation::PreCallValidateCmdTraceRaysIndirectKHR(VkCommandBuffer commandBuffer,
    ...
    _carryOverObjects.add(commandBuffer);
    if (pRaygenShaderBindingTable != nullptr) {
        const auto _s466 = pRaygenShaderBindingTable;
        skip |= ValidateStridedDeviceAddressRegionKHR(_carryOverObjects, _s466->deviceAddress, _s466->stride, _s466->size);
    }
    if (pMissShaderBindingTable != nullptr) {
        const auto _s467 = pMissShaderBindingTable;
        skip |= ValidateStridedDeviceAddressRegionKHR(_carryOverObjects, _s467->deviceAddress, _s467->stride, _s467->size);
    }
    if (pHitShaderBindingTable != nullptr) {
        const auto _s468 = pHitShaderBindingTable;
        skip |= ValidateStridedDeviceAddressRegionKHR(_carryOverObjects, _s468->deviceAddress, _s468->stride, _s468->size);
    }
    if (pCallableShaderBindingTable != nullptr) {
        const auto _s469 = pCallableShaderBindingTable;
        skip |= ValidateStridedDeviceAddressRegionKHR(_carryOverObjects, _s469->deviceAddress, _s469->stride, _s469->size);
    }
    return skip;
}
